...
internal val Shimmer.colors: IntArray
  get() {
    ...
    return when (shape) {
      Shimmer.Shape.Linear -> intArrayOf(
        mixedBaseColor,
        mixedHighlightColor,
        mixedHighlightColor,
        mixedBaseColor,
      ...
      Shimmer.Shape.Radial -> intArrayOf(
        mixedHighlightColor,
        mixedHighlightColor,
        mixedBaseColor,
        mixedBaseColor,
...
internal val Shimmer.positions
  get() = when (shape) {
    Shimmer.Shape.Linear -> floatArrayOf(
    ...
    Shimmer.Shape.Radial -> floatArrayOf(
      0f,
...
internal val Shimmer.Direction.isVertical
  get() = when (this) {
    ...
    Shimmer.Direction.BottomToTop -> true
    Shimmer.Direction.LeftToRight,
    Shimmer.Direction.RightToLeft -> false
  }