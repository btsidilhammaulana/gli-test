...
class FragmentAppLauncher(
  ...
  private fun registerActivityResultLauncher() {
    ...
    activityResultLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerIntentSenderLauncher() {
    ...
    intentSenderLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerRequestPermissionsLauncher() {
    ...
    requestPermissionsLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerTakePicturePreviewLauncher() {
    ...
    takePicturePreviewLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerTakePictureLauncher() {
    ...
    takePictureLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerCaptureVideoLauncher() {
    ...
    captureVideoLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerPickContactLauncher() {
    ...
    pickContactLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerPickVisualMediaLauncher() {
    ...
    pickVisualMediaLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerPickMultipleVisualMediaLauncher() {
    ...
    pickMultipleVisualMediaLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerGetContentLauncher() {
    ...
    getContentLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerMultipleGetContentsLauncher() {
    ...
    getMultipleContentsLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerOpenDocumentLauncher() {
    ...
    openDocumentLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerOpenMultipleDocumentsLauncher() {
    ...
    openMultipleDocumentsLauncher = fragment.registerForActivityResult(contract) {
  ...
  private fun registerOpenDocumentTreeLauncher() {
    ...
    openDocumentTreeLauncher = fragment.registerForActivityResult(contract) {
