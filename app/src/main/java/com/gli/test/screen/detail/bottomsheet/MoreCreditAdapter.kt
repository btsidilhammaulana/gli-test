...
import com.gli.test.screen.detail.adapter.credit.CreditViewHolder

class MoreCreditAdapter : RecyclerView.Adapter<CreditViewHolder>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CreditViewHolder {
    ...
    return CreditViewHolder(binding, true)
  }
